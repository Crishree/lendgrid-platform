...
import { Building2, HandCoins, Layers3, Palette, Sparkles, Workflow, BarChart3 } from "lucide-react";
      ...
      <div className="container-shell flex h-18 items-center justify-between py-3">
        <Link href="/" className="flex items-center gap-3 text-lg font-semibold tracking-tight">
          ...
          <span className="flex flex-col leading-none">
            <span>LendGrid</span>
            <span className="text-xs font-medium text-muted-foreground">Global credit marketplace</span>
          </span>
        </Link>
