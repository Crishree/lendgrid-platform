    ...
    <main className="container-shell py-20">
      ...
      <div className="mt-10 grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="grid gap-4">
          ...
          <Card>
            <CardContent className="p-8">
              <p className="field-label">Deployment model</p>
              <div className="mt-4 space-y-3">
                {[
                  "Cloud-hosted SaaS delivery",
                  "Customizable modules by client requirement",
                  "API-ready architecture for lender and channel integrations",
                  "White-label-ready experience for enterprise distribution partners"
                ].map((item) => (
                  <div key={item} className="feature-row">{item}</div>
                ))}
              </div>
