      ...
      <div className="container-shell grid gap-10 lg:grid-cols-[1.1fr_0.9fr_0.9fr_0.9fr]">
        ...
        <div className="text-sm text-muted-foreground">
          ...
          <div className="mt-3 space-y-2">
            ...
            <Link href="/dsa-portal" className="block">DSA panel</Link>
            <Link href="/partners" className="block">Provider onboarding</Link>
            <Link href="/lender-portal" className="block">Lender panel</Link>
          </div>
        </div>
        ...
        <div className="text-sm text-muted-foreground">
          ...
          <div className="mt-3 space-y-2">
            <Link href="/admin" className="block">LendGrid admin</Link>
            <Link href="/analytics" className="block">Business analytics</Link>
            ...
            <Link href="/integrations" className="block">KYC & bureau integrations</Link>
          </div>
        </div>
      </div>
    </footer>
